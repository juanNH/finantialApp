...
export const parseVariablesToObj = (data: ExternalBcraVariable[]) => {
    const variables: FormattedBcraVariables = {
    } as FormattedBcraVariables
 ...
 */
const orderData = (variable: ExternalBcraVariable, variables: FormattedBcraVariables) => {
